...
class Dashboard extends React.Component {
    ...
    activateModalSnippet() {
        ...
        var $formE2 = $('<form class="mui--text-center formE2">' +
            ...
            <div>
                            ...
                            <tr>
                                ...
                                <td className="mui--text-body2">
                                    <form>
                                        ...
                                        <input type="text" name="search" placeholder="Search for snippets..."/>
                                    </form>
                                </td>
                                <td align="right">
                                    <ul className="mui-list--inline mui--text-body2">
                                        ...
                                        <li>
                                            <img className="img-user" src="images/img-user.jpg" alt="image profil"/>
                            ...
                            <div className="mui-col-md-6" id="content">
                                <div className="easy2">
                                    <div className="mui--text-center mui--align-bottom">
                                        <span id="p2Back"><a href="#"><i className="fa fa-ellipsis-h" aria-hidden="true"></i></a></span>
                                    </div>
                                    <p>Message</p>
                                </div>
                                <div className="easy1">
                                    <div className="mui--text-center mui--align-bottom">
                                        <span id="p1Next"><a href="#"><i className="fa fa-ellipsis-h" aria-hidden="true"></i></a></span>
                                    </div>
                                    <p>Content</p>
                                </div>
                            </div>
                ...
                <footer>
                    <div className="mui-container mui--text-center">
                        <p>
                            Developers <a href="#">Gaspard Lehembreg</a>, <a href="#">Guillaume Suiffet</a>, <a href="#">Olivia Otastet</a>
                        </p>
                    </div>
                </footer>
            </div>
